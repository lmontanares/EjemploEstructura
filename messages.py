    ...
    def get_agent_message(self):
        ...
        if self._suggestions:
            ...
            for suggestion_chip in self._suggestions:
                suggestion_chips.append(suggestion_chip.get_suggestion_chip_object())
...
class StandaloneCard(Message):
    ...
    def get_agent_message(self):
        ...
        if self._file_resource_id:
            ...
            media["contentInfo"] = {
                "fileUrl": self._file_resource_id,
                "forceRefresh": False,
        ...
        if self._suggestions:
            ...
            for suggestion_chip in self._suggestions:
                suggestion_chips.append(suggestion_chip.get_suggestion_chip_object())
            agent_content_message["suggestions"] = suggestion_chips
    ...
    def prepare_to_send(self):
        ...
        if not self._file_resource_id and self._url:
            self._file_resource_id = rbm_service.upload_file(self._url, self._thumbnail_url)  # type: ignore
    ...
    def get_agent_message(self):
        ...
        if self._card_contents:
            ...
            for card_content in self._card_contents:
                card_contents_array.append(card_content.get_card_content_object())
...
class CardContent(object):
    ...
    def __init__(self, title, description, image_url, image_height, suggestions):
        """
        Constructor.
    ...
    def get_card_content_object(self):
        ...
        Returns:
           A :dict:Dictionary representation of the message to be sent.
        """
        card_content = {"title": self._title, "description": self._description}
        ...
        if self._image_url:
            card_content["media"] = {
                "contentInfo": {"fileUrl": self._image_url, "forceRefresh": False},
...
class SuggestedReply(SuggestionChip):
    ...
    def get_suggestion_chip_object(self):
        ...
        """
        return {"reply": {"text": self._text, "postbackData": self._postback_data}}
...
class ViewLocationAction(SuggestionChip):
    ...
    def __init__(self, text, postback_data, lat=None, lon=None, label=None, query=None, fallback_url=None):
        """
        Constructor.
...
class DialAction(SuggestionChip):
    ...
    def __init__(self, text, postback_data, phone_number, fallback_url=None):
        ...
        """
        self._text = text
        self._postback_data = rf"{{{{mapping_id}}}}:{postback_data}"
    ...
    def get_suggestion_chip_object(self):
        ...
        return {
            "action": {
                ...
                "postbackData": self._postback_data,
                "fallbackUrl": self._fallback_url,
                "dialAction": {"phoneNumber": self._phone_number},
            }
        }
...
class CreateCalendarEventAction(SuggestionChip):
    ...
    def __init__(self, text, postback_data, start_time, end_time, title=None, description=None, fallback_url=None):
        """
        Constructor.
    ...
    def get_suggestion_chip_object(self):
        ...
        """
        create_calendar_event_action = {"startTime": self._start_time, "endTime": self._end_time}
...
class OpenUrlAction(SuggestionChip):
    ...
    def get_suggestion_chip_object(self):
        ...
        """
        return {
            "action": {"text": self._text, "postbackData": self._postback_data, "openUrlAction": {"url": self._url}}
        }
